...
public class Main
{
    ...
    private static String gradeStudent(CourseService courseService, StudentService studentService, Scanner scanner )
    {
        ...
        if ( student != null && course!=null) {
            ...
            System.out.println( studentId + " score is " + studentGrade  );
               }
           else
        {
